...
legal choices in the fully splitting ring NFLlib gives us. It also fixes a
second, independent hole: every equality the verifier checked was NFLlib's
element-wise `operator==`, which is true as soon as the two sides agree in one
of the 8192 NTT slots.
